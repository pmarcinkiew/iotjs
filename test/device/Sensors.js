...
function Sensors(configuration) {
  console.log('gpio sensors ', configuration.soilHumidity.pin);
  ...
  console.log('gpio sensors ', configuration.overflow.pin);
  ...
  console.log('gpio sensors ', configuration.light.pin);
  ...
  console.log('gpio sensors ', configuration.waterLevel.pin);
