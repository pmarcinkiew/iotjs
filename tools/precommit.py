...
def parse_option():
    ...
    parser.add_argument('--skipbuild', choices=[True, False], action='store', nargs='?', const=True, default=False)
    parser.add_argument('--romfs', choices=ROMFS_MODULES, action='append', default=[])
